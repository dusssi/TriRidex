                ...
                <div className='flex-grow relative'>
                    ...
                    <div className='absolute top-5 left-5 z-30'>
                        <div className="w-16 h-16 bg-black border border-gray-800 rounded-xl flex items-center justify-center shadow">
                            <span className="text-white font-[Urbanist] text-[10px] tracking-wide">TriRidex</span>
                        </div>
                    </div>

                    <div className='absolute top-5 right-5 z-30'>
                        <Link to='/captain-home' className='h-10 w-10 bg-black flex items-center justify-center rounded-full shadow hover:bg-gray-900 transition-all duration-300'>
