...
const VehiclePanel = (props) => {
  return (
    <div className="bg-[#121212] text-white p-4 rounded-lg">
      <h5
      ...
      <div
        ...
        className='flex border border-gray-600 hover:border-white active:border-white bg-[#1e1e1e] mb-3 rounded-xl w-full p-3 items-center justify-between cursor-pointer'
      >
        <img className='h-10' src="https://swyft.pl/wp-content/uploads/2023/05/how-many-people-can-a-uberx-take.jpg" alt="" />
        <div className='ml-2 w-1/2'>
          <h4 className='font-medium text-base'>Tricab <span><i className="ri-user-3-fill"></i>4</span></h4>
      ...
      >
        ...
        <div className='-ml-2 w-1/2'>
          <h4 className='font-medium text-base'>TriMoto <span><i className="ri-user-3-fill"></i>1</span></h4>
      ...
      >
        ...
        <div className='ml-2 w-1/2'>
          <h4 className='font-medium text-base'>TriAuto <span><i className="ri-user-3-fill"></i>3</span></h4>
          <h5 className='font-medium text-sm text-gray-300'>3 mins away</h5>
